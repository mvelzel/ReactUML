...
public class SelectFormGenerator extends DefaultSingleGenerator implements Generator {
    ...
    public void generateFullText() {
        ...
        this.appendFullText("class SelectForm extends Form {\n" +
		    ...
		    "        this.fields = {\n" +
	        "            id: new class extends FormFieldList('Select') { constructor(){ super(); this.name = 'id'; this.sequence = '01'; this.attribute = Attribute.SelectionAttribute({ name: 'id', options: spec.options || [], label: '', defaultFieldType: FormField.Select, help: 'Maak een selectie...' }); this.width = '12'; this.offset = '0'; this.getFocus = true;} }()\n" +
	        "        };\n" +
