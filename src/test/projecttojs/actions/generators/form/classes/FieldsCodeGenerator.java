...
//        if (defaultFieldType != null && defaultFieldType.getInitialValue() != null) {
            return "            " + attribute.getName() + ": new class extends FormField." + attribute.getTypeAsString() + " { constructor(){ super(); this.sequence = '" + sequence + "'; this.attribute = new " + this.getDefinition().getName() + "().attributes." + attribute.getName() + "; this.width = '" + width + "'; this.offset = '" + offset + "'; this.getFocus = " + getFocus + ";} }()";
//        }
//        else {
...
//        }
    ...
    private String fieldFromAssociation(IAssociation association){
	    ...
	    return "            " + thisEnd.getName() + ": new class extends FormField." + fieldType + " { constructor(){ super(); this.sequence = '" + sequence + "'; this.attribute = " + this.getDefinition().getName() + "().associations." + thisEnd.getName() + "; this.width = '" + width + "'; this.offset = '" + offset + "'; this.getFocus = " + getFocus + "; this.options = " + options + ";} }()";
    }
