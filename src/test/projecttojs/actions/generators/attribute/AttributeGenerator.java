...
import test.projecttojs.actions.generators.attribute.constructor.ConstructorGenerator;
import test.projecttojs.actions.generators.attribute.operations.OperationsGenerator;

public class AttributeGenerator extends DefaultSingleGenerator implements Generator {
    public AttributeGenerator(ClassDefinition definition) {
        super(definition);
    }
    ...
    public void generateFullText() {
        ...
        this.appendFullText("// " + this.getDefinition().getName() + " Class\n" +
                ...
                importsCode +
                "\n" +
                "class " + this.getDefinition().getName() + " extends Attribute {\n" +
                constructorCode + "\n" +
                operationsCode +
                "}\n\n" +
